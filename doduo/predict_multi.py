...
from util import parse_tagname, f1_score_multilabel, f1_score_multilabel2
...
if __name__ == "__main__":
    ...
    print("shortcut_name dofsjoisjf", tag_name)
    colpair = False
    ...
    for task, num_classes in zip(tasks, num_classes_list):
        ...
        if task in [
            ...
            if task in ["turl"]:
                filepath = "data/delete_test_col_type_serialized.pkl"
        ...
        for f1_name, model_path in [("f1_micro", f1_micro_model_path)]:
            print(model_path)
